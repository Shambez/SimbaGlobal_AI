...
with_node \
  ...
  --target "/Users/shambebabu/Desktop/SimbaGlobal_AI/ios/Pods/Target Support Files/Pods-SimbaGlobalAI/ExpoModulesProvider.swift" \
  --entitlement "/Users/shambebabu/Desktop/SimbaGlobal_AI/ios/SimbaGlobalAI/SimbaGlobalAI.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-asset" "expo-av" "expo-blur" "expo-camera" "expo-constants" "expo-dev-launcher" "expo-dev-menu" "expo-eas-client" "expo-file-system" "expo-font" "expo-haptics" "expo-image" "expo-keep-awake" "expo-linking" "expo-location" "expo-router" "expo-speech" "expo-splash-screen" "expo-symbols" "expo-system-ui" "expo-updates" "expo-web-browser"
